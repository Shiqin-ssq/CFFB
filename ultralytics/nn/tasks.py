...
# from ultralytics.nn.modules.block import C3_PG, PGConv, PConv, Shuffle
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in {
            ...
            C3k2_RepVGG,
            Down_wt,
            C3k2_WTConv,DSC3k2,PSPPF
        }:
            c1, c2 = ch[f], args[0]
            print(
                f"Layer {i}: Module {m.__name__}, c1 (in_channels)={c1}, c2 (out_channels)={c2}, args before adjustment: {args}")
            ...
            if m in {
                ...
                C3k2_RepVGG,C3k2_WTConv,DSC3k2
            }:
                args.insert(2, n)  # number of repeats
                n = 1
            if m in {C3k2, C3k2_WTConv,DSC3k2} and scale in "mlx":  # for M/L/X sizes
                args[3] = True
        elif m is AIFI:
            args = [ch[f], *args]
        #DySample
